...
public:
	virtual LoggingResponse_t ThrowAssert(const LeafCodeInfo_t &aCode, const char *pszContent) const;
	virtual LoggingResponse_t ThrowAssert(const LeafCodeInfo_t &aCode, Color aColor, const char *pszContent) const;
